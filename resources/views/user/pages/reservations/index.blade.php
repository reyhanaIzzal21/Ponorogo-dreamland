    ...
    <section class="pb-24 bg-zinc-50 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
                ...
                {{-- <a href="{{ route('reservations.form', ['type' => 'resto']) }}" class="group block h-full"> --}}
                    ...
                    <div
                        ...
                        <div class="h-64 overflow-hidden relative">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="bg-forest-green text-white text-xs font-bold px-3 py-1 rounded-full shadow-md">
                                    Open Daily
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-8 flex-1 flex flex-col border-t-4 border-forest-green">
                            ...
                            <p class="text-zinc-500 text-sm mb-6 flex-1 leading-relaxed">
                                Pesan meja untuk makan siang santai, makan malam romantis, atau kumpul keluarga hangat.
                            </p>

                            <div class="flex items-center text-forest-green font-bold text-sm">
                                Buat Reservasi
                                <svg class="w-4 h-4 ml-2 transform group-hover:translate-x-2 transition" fill="none"
                ...
                {{-- <a href="{{ route('reservations.form', ['type' => 'pendopo']) }}" class="group block h-full"> --}}
                <a href="{{ route('reservation.form') }}" class="group block h-full">
                    <div
                        class="booking-card bg-white rounded-2xl overflow-hidden shadow-lg border border-zinc-100 h-full flex flex-col relative">
                        <div class="h-64 overflow-hidden relative">
                            <img src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?q=80&w=800&auto=format&fit=crop"
                                class="w-full h-full object-cover transition duration-700 group-hover:scale-110"
                                alt="Pendopo Ageng">
                            <div class="absolute top-4 left-4">
                                <span class="bg-earth text-white text-xs font-bold px-3 py-1 rounded-full shadow-md">
                                    Event Venue
                                </span>
                            </div>
                        </div>

                        <div class="p-8 flex-1 flex flex-col border-t-4 border-earth">
                            <h3
                                class="font-heritage text-2xl font-bold text-zinc-800 mb-2 group-hover:text-earth transition">
                                Pendopo Ageng
                            </h3>
                            <p class="text-zinc-500 text-sm mb-6 flex-1 leading-relaxed">
                                Booking ruang elegan untuk pernikahan impian, rapat perusahaan, atau acara spesial lainnya.
                            </p>
                    ...
                    <div
                        ...
                        <div class="absolute inset-0 z-20 flex items-center justify-center">
                            <div
                                ...
                                <span class="block text-xl font-bold text-secondary tracking-wide">COMING SOON</span>
                            </div>
                        </div>
                        ...
                        <div class="h-64 overflow-hidden relative bg-blue-900">
                            ...
                            <img src="https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?q=80&w=800&auto=format&fit=crop"
                                class="w-full h-full object-cover opacity-60" alt="Kolam Renang">
                        </div>
                        ...
                        <div class="p-8 flex-1 flex flex-col border-t-4 border-zinc-300">
                            ...
                            <p class="text-zinc-400 text-sm mb-6 flex-1 leading-relaxed">
                                Area rekreasi air keluarga dengan fasilitas modern. Nantikan kesegarannya segera.
                            </p>
