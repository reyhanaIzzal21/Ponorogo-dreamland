...
@section('content')
    <section class="relative h-[90vh] flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute inset-0 bg-[#B71C1C] opacity-40 mix-blend-multiply"></div>
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto fade-up">
            <h1 class="font-heritage text-5xl md:text-7xl text-white font-bold mb-6 drop-shadow-lg leading-tight">
                ...
                <span class="italic font-light text-[#FBC02D]">di Jantung Ponorogo</span>
            </h1>
            ...
            <a href="#reservation"
                class="group relative inline-flex items-center justify-center px-8 py-4 text-base font-bold text-[#1B5E20] transition-all duration-200 bg-[#FBC02D] font-modern rounded-full hover:bg-[#ffcf40] hover:scale-105 shadow-[0_0_20px_rgba(251,192,45,0.4)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FBC02D]">
    ...
    <section class="py-24 bg-[#FFF8E1]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 fade-up">
                <h3 class="text-[#B71C1C] font-bold tracking-widest uppercase text-sm mb-2">Pilihan Chef</h3>
                <h2 class="font-heritage text-4xl md:text-5xl text-[#1B5E20] font-bold">Menu Andalan Kami</h2>
                <div class="w-24 h-1 bg-[#FBC02D] mx-auto mt-6"></div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div
                    class="group relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 fade-up border border-[#FBC02D]/20">
                    <div class="h-72 overflow-hidden relative">
                        ...
                        <div
                            class="absolute top-4 right-4 bg-[#FBC02D] text-black text-xs font-bold px-3 py-2 rounded-lg shadow-md uppercase tracking-wider">
                            ★ Best Seller
                        </div>
                    </div>
                    <div class="p-8 text-center relative">
                        <div
                            class="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-[#FFF8E1] rounded-full flex items-center justify-center border border-[#FBC02D]">
                            <span class="text-xl">🌶️</span>
                        </div>
                        <h3 class="font-heritage text-2xl font-bold text-[#1B5E20] mb-2 mt-4">Sate Ponorogo Premium</h3>
                        ...
                        <p class="font-heritage text-2xl text-[#B71C1C] font-bold">Rp 35.000</p>
                    </div>
                </div>

                <div class="group relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 fade-up border border-[#FBC02D]/20"
                    ...
                    <div class="p-8 text-center relative">
                        ...
                        <h3 class="font-heritage text-2xl font-bold text-[#1B5E20] mb-2 mt-4">Nasi Pecel Pincuk</h3>
                        ...
                        <p class="font-heritage text-2xl text-[#B71C1C] font-bold">Rp 18.000</p>
                    </div>
                </div>
                ...
                <div class="group relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 fade-up border border-[#FBC02D]/20"
                    ...
                    <div class="p-8 text-center relative">
                        ...
                        <h3 class="font-heritage text-2xl font-bold text-[#1B5E20] mb-2 mt-4">Es Dawet Jabung</h3>
                        ...
                        <p class="font-heritage text-2xl text-[#B71C1C] font-bold">Rp 12.000</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-white relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-10 fade-up">
                <h2 class="font-heritage text-4xl text-[#1B5E20] font-bold mb-6">Jelajahi Rasa</h2>

                <div class="flex flex-wrap justify-center gap-4 mb-12" id="menuTabs">
                    <button onclick="switchTab('berat')"
                        class="tab-btn px-6 py-2 rounded-full border-2 border-[#1B5E20] text-[#1B5E20] font-bold hover:bg-[#1B5E20] hover:text-white transition active-tab"
                        data-target="berat">Makanan Berat</button>
                    <button onclick="switchTab('camilan')"
                        class="tab-btn px-6 py-2 rounded-full border-2 border-[#1B5E20] text-[#1B5E20] font-bold hover:bg-[#1B5E20] hover:text-white transition"
            ...
            <div id="menuContent" class="min-h-[100px] fade-up">
                <div id="berat-content" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 tab-pane">
                    <div class="flex items-center gap-4 p-4 border rounded-lg hover:shadow-md transition bg-[#FFF8E1]">
                        ...
                        <div>
                            <h4 class="font-bold text-[#1B5E20] font-heritage">Ayam Lodho</h4>
                            <span class="text-[#B71C1C] font-bold text-sm">Rp 28.000</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 p-4 border rounded-lg hover:shadow-md transition bg-[#FFF8E1]">
                        <img src="https://images.unsplash.com/photo-1626804475297-411dbe11261c?w=150"
                            class="w-20 h-20 rounded-lg object-cover">
                        <div>
                            <h4 class="font-bold text-[#1B5E20] font-heritage">Rawon Setan</h4>
                            <span class="text-[#B71C1C] font-bold text-sm">Rp 30.000</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 p-4 border rounded-lg hover:shadow-md transition bg-[#FFF8E1]">
                        <img src="https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=150"
                            class="w-20 h-20 rounded-lg object-cover">
                        <div>
                            <h4 class="font-bold text-[#1B5E20] font-heritage">Soto Lamongan</h4>
                            <span class="text-[#B71C1C] font-bold text-sm">Rp 22.000</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 p-4 border rounded-lg hover:shadow-md transition bg-[#FFF8E1]">
                        <img src="https://images.unsplash.com/photo-1596450523098-9994c6575196?w=150"
                            class="w-20 h-20 rounded-lg object-cover">
                        <div>
                            <h4 class="font-bold text-[#1B5E20] font-heritage">Bebek Goreng</h4>
                            <span class="text-[#B71C1C] font-bold text-sm">Rp 32.000</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mt-12">
                <a href="{{ url('/menu') }}"
                    class="inline-block text-[#B71C1C] border-b-2 border-[#B71C1C] font-bold hover:text-[#1B5E20] hover:border-[#1B5E20] transition pb-1">
    ...
    <section class="py-24 bg-[#1B5E20] text-[#FFF8E1] relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 fade-up">
                    <h3 class="text-[#FBC02D] font-bold tracking-widest uppercase text-sm mb-4">Filosofi Kami</h3>
                ...
                <div class="lg:w-1/2 relative fade-up" style="transition-delay: 200ms;">
                    <div class="absolute -top-4 -left-4 w-24 h-24 border-t-4 border-l-4 border-[#FBC02D]"></div>
                    <div class="absolute -bottom-4 -right-4 w-24 h-24 border-b-4 border-r-4 border-[#FBC02D]"></div>
                    <img src="https://images.unsplash.com/photo-1559339352-11d035aa65de?q=80&w=1000&auto=format&fit=crop"
    ...
    <section class="py-24 bg-[#FFF8E1]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 fade-up">
                <div>
                    <h2 class="font-heritage text-4xl text-[#1B5E20] font-bold mb-2">Sudut Estetik</h2>
                    <p class="text-gray-600">Abadikan momen terbaikmu di Dam Cokro.</p>
                </div>
                <div class="mt-4 md:mt-0 flex gap-2">
                    <a href="#"
                        class="bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white px-4 py-2 rounded-lg font-bold text-sm flex items-center gap-2 hover:shadow-lg transition">
